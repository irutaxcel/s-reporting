        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <?php if ($title == 'Personnel Chantier' || $title == 'Achats & Approvisionnement' || $title == 'Projets' || $title == 'Chantiers & exécution' || $title == 'Sous-traitants' || $title == 'Stocks') { ?>
                    ...
                    DAF / FINANCE
                =========================== -->
                    <?php if ($title == 'Tableau de Bord DAF'  || $title == 'Exercices Comptables' || $title == 'Classes de Comptes' || $title == 'Plan Comptable') { ?>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <!-- COMPTABILITE -->
                                <?php if ($title == 'Exercices Comptables' || $title == 'Classes de Comptes' || $title == 'Plan Comptable') { ?>
                                    <li class="nav-item has-treeview menu-open">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        <li class="nav-item">
                                            <a href="<?= base_url('finance/journal-codes') ?>" class="nav-link">
                                        ...
                                        <li class="nav-item">
                                            <a href="<?= base_url('finance/accounting-entry') ?>" class="nav-link">
