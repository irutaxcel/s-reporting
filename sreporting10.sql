...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 13 juil. 2026 à 16:40
...
CREATE TABLE `tbl_finance_bank_operation` (
  ...
  `label` text NOT NULL,
  `status` enum('pending','validated','cancelled') DEFAULT 'validated',
  `created_by` int(11) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `tbl_finance_bank_operation`
  ADD CONSTRAINT `tbl_finance_bank_operation_ibfk_1` FOREIGN KEY (`bank_account_id`) REFERENCES `tbl_finance_bank_account` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `tbl_finance_bank_operation_ibfk_2` FOREIGN KEY (`destination_account_id`) REFERENCES `tbl_finance_bank_account` (`id`) ON DELETE SET NULL;
