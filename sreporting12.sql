...
--
-- Hôte : localhost
-- Généré le : mer. 15 juil. 2026 à 17:26
...
CREATE TABLE `tbl_engin_categorie` (
  `id` int(11) NOT NULL,
...
--
-- Structure de la table `tbl_engin_code`
--

CREATE TABLE `tbl_engin_code` (
  `id` int(11) NOT NULL,
...
--
-- Structure de la table `tbl_engin_document`
--
...
--
-- Structure de la table `tbl_engin_fuel`
--
...
--
-- Structure de la table `tbl_engin_maintenance`
--
...
--
-- Structure de la table `tbl_engin_maintenance_document`
--

CREATE TABLE `tbl_engin_maintenance_document` (
  `id` int(11) NOT NULL,
...
--
-- Structure de la table `tbl_engin_materiel`
--

CREATE TABLE `tbl_engin_materiel` (
  `id` int(11) NOT NULL,
  `code_engin` varchar(50) NOT NULL,
...
--
-- Structure de la table `tbl_engin_photo`
--
...
--
-- Structure de la table `tbl_finance_bank_account`
--

CREATE TABLE `tbl_finance_bank_account` (
  `id` int(11) NOT NULL,
  `code` varchar(30) NOT NULL,
  `name` varchar(150) NOT NULL,
  `bank_name` varchar(100) NOT NULL,
  `account_number` varchar(100) NOT NULL,
  `account_type` enum('courant','epargne','garantie','projet','credit') NOT NULL,
  `currency` enum('BIF','USD','EUR') DEFAULT 'BIF',
  `opening_balance` decimal(18,2) DEFAULT 0.00,
  `current_balance` decimal(18,2) DEFAULT 0.00,
  `alert_threshold` decimal(18,2) DEFAULT 0.00,
...
--
-- Déchargement des données de la table `tbl_finance_bank_account`
--

INSERT INTO `tbl_finance_bank_account` (`id`, `code`, `name`, `bank_name`, `account_number`, `account_type`, `currency`, `opening_balance`, `current_balance`, `alert_threshold`, `branch_name`, `swift_code`, `observation`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(1, 'BAN-2026-001', 'CRDB BIF', 'CRDB', '123456789', 'courant', 'BIF', 100000000.00, 130000000.00, 10000000.00, 'Agence Siege', '123456789', 'Je fais des tes', 'active', 22, NULL, '2026-07-13 19:46:19', '2026-07-15 06:45:52'),
(2, 'BAN-2026-002', 'BANCOBU', 'BANCOBU', '9874563210', 'projet', 'BIF', 200000000.00, 140000000.00, 20000000.00, 'Agence Siege', '987654321', 'Je fais des tes', 'active', 22, NULL, '2026-07-13 19:50:01', '2026-07-13 20:46:02'),
(3, 'BAN-2026-003', 'KCB USD', 'KCB', '98745632108741', 'courant', 'USD', 100000.00, 100000.00, 1000.00, 'Agence Siege', '6547893210', 'JE FAIS DES TES', 'active', 22, NULL, '2026-07-13 19:54:29', '2026-07-13 19:54:29'),
(4, 'BAN-2026-004', 'CRDB USD', 'CRDB', '9874563210215', 'courant', 'USD', 200000.00, 200000.00, 2000.00, 'Agence Siege', '552241112', 'JE FAUS TEST', 'active', 22, NULL, '2026-07-13 19:56:05', '2026-07-13 19:56:05'),
(5, 'BAN-2026-005', 'Compte Principal CRDB BIF', 'CRDB', '110000000001', 'courant', 'BIF', 250000000.00, 250000000.00, 10000000.00, 'Agence Siège', 'CRDBBI01', 'Compte principal SATRACO', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51'),
(6, 'BAN-2026-006', 'Compte Projet Kabezi', 'CRDB', '110000000002', 'projet', 'BIF', 75000000.00, 65000000.00, 5000000.00, 'Agence Kabezi', 'CRDBBI02', 'Gestion chantier Kabezi', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51'),
(7, 'BAN-2026-007', 'Compte Bancobu USD', 'BANCOBU', '220000000001', 'courant', 'USD', 500000.00, 425000.00, 5000.00, 'Agence Siège', 'BCBUBI01', 'Compte devise USD', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51'),
(8, 'BAN-2026-008', 'Compte Bancobu BIF', 'BANCOBU', '220000000002', 'courant', 'BIF', 120000000.00, 160000000.00, 5000000.00, 'Agence Siège', 'BCBUBI02', 'Compte exploitation', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-15 06:44:48'),
(9, 'BAN-2026-009', 'Compte Ecobank Projet', 'ECOBANK', '330000000001', 'projet', 'BIF', 95000000.00, 78500000.00, 7000000.00, 'Agence Bujumbura', 'ECOBBI01', 'Projet immobilier', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51'),
(10, 'BAN-2026-010', 'Compte Ecobank USD', 'ECOBANK', '330000000002', 'courant', 'USD', 250000.00, 210000.00, 3000.00, 'Agence Bujumbura', 'ECOBBI02', 'Compte devise USD', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51'),
(11, 'BAN-2026-011', 'Compte KCB BIF', 'KCB', '440000000001', 'courant', 'BIF', 85000000.00, 72000000.00, 5000000.00, 'Agence Rohero', 'KCBBI01', 'Compte principal KCB', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51'),
(12, 'BAN-2026-012', 'Compte KCB USD', 'KCB', '440000000002', 'courant', 'USD', 300000.00, 275000.00, 3000.00, 'Agence Rohero', 'KCBBI02', 'Compte secondaire USD', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51'),
(13, 'BAN-2026-013', 'Compte Garantie CRDB', 'CRDB', '110000000003', 'garantie', 'BIF', 50000000.00, 50000000.00, 1000000.00, 'Agence Siège', 'CRDBBI03', 'Garantie bancaire', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51'),
(14, 'BAN-2026-014', 'Compte Epargne SATRACO', 'BANCOBU', '220000000003', 'epargne', 'BIF', 30000000.00, 29500000.00, 1000000.00, 'Agence Siège', 'BCBUBI03', 'Compte épargne société', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51'),
(15, 'BAN-2026-015', 'Compte Projet Muyinga', 'CRDB', '110000000004', 'projet', 'BIF', 60000000.00, 48000000.00, 5000000.00, 'Agence Muyinga', 'CRDBBI04', 'Projet Muyinga', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51'),
(16, 'BAN-2026-016', 'Compte Projet Ngozi', 'BANCOBU', '220000000004', 'projet', 'BIF', 45000000.00, 31500000.00, 5000000.00, 'Agence Ngozi', 'BCBUBI04', 'Projet Ngozi', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51'),
(17, 'BAN-2026-017', 'Compte Projet Gitega', 'CRDB', '110000000005', 'projet', 'BIF', 70000000.00, 52000000.00, 5000000.00, 'Agence Gitega', 'CRDBBI05', 'Projet Gitega', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51'),
(18, 'BAN-2026-018', 'Compte Projet Kirundo', 'ECOBANK', '330000000003', 'projet', 'BIF', 55000000.00, 25000000.00, 5000000.00, 'Agence Kirundo', 'ECOBBI03', 'Projet Kirundo', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51'),
(19, 'BAN-2026-019', 'Compte Fonctionnement', 'KCB', '440000000003', 'courant', 'BIF', 90000000.00, 88500000.00, 5000000.00, 'Agence Siège', 'KCBBI03', 'Charges fonctionnement', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51'),
(20, 'BAN-2026-020', 'Compte Sous-traitants', 'CRDB', '110000000006', 'courant', 'BIF', 40000000.00, 15000000.00, 3000000.00, 'Agence Siège', 'CRDBBI06', 'Paiement sous-traitants', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51'),
(21, 'BAN-2026-021', 'Compte Importations', 'ECOBANK', '330000000004', 'courant', 'USD', 750000.00, 630000.00, 5000.00, 'Agence Port', 'ECOBBI04', 'Paiement fournisseurs étrangers', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51'),
(22, 'BAN-2026-022', 'Compte Matériel', 'BANCOBU', '220000000005', 'courant', 'BIF', 35000000.00, 12000000.00, 3000000.00, 'Agence Industrielle', 'BCBUBI05', 'Achats matériels', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51'),
(23, 'BAN-2026-023', 'Compte Salaires', 'CRDB', '110000000007', 'courant', 'BIF', 65000000.00, 43000000.00, 5000000.00, 'Agence Siège', 'CRDBBI07', 'Paiement salaires employés', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51'),
(24, 'BAN-2026-024', 'Compte Réserve', 'KCB', '440000000004', 'epargne', 'BIF', 100000000.00, 100000000.00, 10000000.00, 'Agence Siège', 'KCBBI04', 'Fonds de réserve SATRACO', 'active', 22, NULL, '2026-07-13 20:00:51', '2026-07-13 20:00:51');

-- --------------------------------------------------------

--
-- Structure de la table `tbl_finance_bank_operation`
--

CREATE TABLE `tbl_finance_bank_operation` (
  `id` int(11) NOT NULL,
  `reference` varchar(50) NOT NULL,
  `operation_type` enum('encaissement','decaissement','transfert') NOT NULL,
  `operation_date` date NOT NULL,
  `source_bank_account_id` int(11) DEFAULT NULL,
  `destination_bank_account_id` int(11) DEFAULT NULL,
  `amount` decimal(18,2) NOT NULL DEFAULT 0.00,
  `currency` enum('BIF','USD','EUR') NOT NULL DEFAULT 'BIF',
  `category` varchar(100) DEFAULT NULL,
  `third_party` varchar(255) DEFAULT NULL,
  `payment_method` enum('transfer','deposit','cheque','withdrawal') NOT NULL DEFAULT 'transfer',
...
--
-- Déchargement des données de la table `tbl_finance_bank_operation`
--

INSERT INTO `tbl_finance_bank_operation` (`id`, `reference`, `operation_type`, `operation_date`, `source_bank_account_id`, `destination_bank_account_id`, `amount`, `currency`, `category`, `third_party`, `payment_method`, `document_number`, `attachment`, `label`, `status`, `created_by`, `validated_by`, `created_at`, `updated_at`) VALUES
(1, 'BMV-2026-00001', 'encaissement', '2026-07-13', NULL, 2, 40000000.00, 'BIF', 'paiement_client', 'Banque', 'deposit', '43545645645', 'dbeef2e9153008edbe610edc72a98723.pdf', 'Je veux faire un test', 'validated', 22, 22, '2026-07-13 20:42:38', NULL),
(2, 'BMV-2026-00002', 'decaissement', '2026-07-13', 2, NULL, 50000000.00, 'BIF', 'paiement_client', 'adams', 'deposit', '223222', '41e4f3c5e86b0ef2eb4a82b084ae1359.pdf', 'je veux faire un test', 'validated', 22, 22, '2026-07-13 20:44:01', NULL),
(3, 'BMV-2026-00003', 'transfert', '2026-07-13', 2, 8, 50000000.00, 'BIF', 'salaire', 'Baque', 'deposit', '7878978', '6a0a73c66ce7c27b6b1fa6ea45d224d5.pdf', 'Je veux faire un tes aussi', 'validated', 22, 22, '2026-07-13 20:46:02', NULL),
(4, 'BMV-2026-00004', 'decaissement', '2026-07-15', 8, NULL, 3000000.00, 'BIF', 'impot', 'Caisse Muha', 'transfer', '45654564564', '01de20bcb7513c9a52b2632bf707d710.pdf', 'je fais les de cais ekeke', 'validated', 22, 22, '2026-07-15 06:44:48', NULL),
(5, 'BMV-2026-00005', 'encaissement', '2026-07-15', NULL, 1, 30000000.00, 'BIF', 'fournisseur', 'adams', 'transfer', '785756756', '815423aabf05c45df316e795f3f9ea06.pdf', 'icic je fa is le dek', 'validated', 22, 22, '2026-07-15 06:45:52', NULL);
...
CREATE TABLE `tbl_finance_cashbox` (
  ...
  `code` varchar(30) NOT NULL,
  `name` varchar(150) NOT NULL,
  `type` enum('siege','chantier') NOT NULL,
  `chantier_id` bigint(20) UNSIGNED DEFAULT NULL,
...
INSERT INTO `tbl_finance_cashbox` (`id`, `code`, `name`, `type`, `chantier_id`, `responsable`, `devise`, `opening_balance`, `current_balance`, `alert_threshold`, `observation`, `status`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 'CAI-2026-001', 'Caisse General', 'siege', NULL, 'Nally Ange', 'BIF', 150000000.00, 70000000.00, 1000000.00, 'Ici c\'est le test', 'active', 22, '2026-07-12 20:20:56', '2026-07-15 14:22:41'),
(2, 'CAI-2026-002', 'TEMOINS DE JEHOVAH', 'chantier', 2, 'Jeannette', 'BIF', 50000000.00, 41500000.00, 500000.00, 'Ici aussi le test pour cette caisse', 'active', 22, '2026-07-12 20:22:59', '2026-07-13 09:26:14'),
(3, 'CAI-2026-003', 'Caisse chantier IBB entrepots', 'chantier', 1, NULL, 'BIF', 0.00, 1000000.00, 500000.00, 'Caisse associée au chantier IBB entrepots', 'active', 22, '2026-07-12 21:11:30', '2026-07-13 09:14:07'),
(4, 'CAI-2026-004', 'Caisse chantier KABEZI', 'chantier', 3, NULL, 'BIF', 0.00, 1000000.00, 500000.00, 'Caisse associée au chantier KABEZI', 'active', 22, '2026-07-12 21:11:30', '2026-07-13 09:15:26'),
(5, 'CAI-2026-005', 'Caisse chantier KING\'S SCHOOL', 'chantier', 4, NULL, 'BIF', 0.00, 11000000.00, 500000.00, 'Caisse associée au chantier KING\'S SCHOOL', 'active', 22, '2026-07-12 21:11:30', '2026-07-13 09:16:22'),
(6, 'CAI-2026-006', 'Caisse chantier MUHA', 'chantier', 5, NULL, 'BIF', 0.00, 5000000.00, 500000.00, 'Caisse associée au chantier MUHA', 'active', 22, '2026-07-12 21:11:30', '2026-07-12 23:50:43'),
(7, 'CAI-2026-007', 'Caisse chantier GIHOSHA APPARTEMENT', 'chantier', 6, NULL, 'BIF', 0.00, 3000000.00, 500000.00, 'Caisse associée au chantier GIHOSHA APPARTEMENT', 'active', 22, '2026-07-12 21:11:30', '2026-07-13 09:17:40'),
(8, 'CAI-2026-008', 'Caisse chantier GIHOSHA ZONE', 'chantier', 7, NULL, 'BIF', 0.00, 6000000.00, 500000.00, 'Caisse associée au chantier GIHOSHA ZONE', 'active', 22, '2026-07-12 21:11:30', '2026-07-13 09:19:44'),
(9, 'CAI-2026-009', 'Caisse chantier AVENANT 8', 'chantier', 8, NULL, 'BIF', 0.00, 5000000.00, 500000.00, 'Caisse associée au chantier AVENANT', 'active', 22, '2026-07-12 21:11:30', '2026-07-13 09:20:38'),
(10, 'CAI-2026-010', 'Caisse chantier AVENANT 9', 'chantier', 9, NULL, 'BIF', 0.00, 0.00, 500000.00, 'Caisse associée au chantier AVENANT', 'active', 22, '2026-07-12 21:11:30', NULL),
(11, 'CAI-2026-011', 'Caisse chantier AVENANT 10', 'chantier', 10, NULL, 'BIF', 0.00, 0.00, 500000.00, 'Caisse associée au chantier AVENANT', 'active', 22, '2026-07-12 21:11:30', NULL),
(12, 'CAI-2026-012', 'Caisse chantier GAKUNGWE', 'chantier', 11, NULL, 'BIF', 0.00, 0.00, 500000.00, 'Caisse associée au chantier GAKUNGWE', 'active', 22, '2026-07-12 21:11:30', NULL),
(13, 'CAI-2026-013', 'Caisse chantier JABE USDA', 'chantier', 12, NULL, 'BIF', 0.00, 0.00, 500000.00, 'Caisse associée au chantier JABE USDA', 'active', 22, '2026-07-12 21:11:30', NULL),
(14, 'CAI-2026-014', 'Caisse chantier NYABUGETE DR', 'chantier', 13, NULL, 'BIF', 0.00, 0.00, 500000.00, 'Caisse associée au chantier NYABUGETE DR', 'active', 22, '2026-07-12 21:11:30', NULL),
(15, 'CAI-2026-015', 'Caisse chantier GATOKE CLAUDOIR', 'chantier', 14, NULL, 'BIF', 0.00, 0.00, 500000.00, 'Caisse associée au chantier GATOKE CLAUDOIR', 'active', 22, '2026-07-12 21:11:30', NULL),
(16, 'CAI-2026-016', 'Caisse chantier KININDO APPARTEMENT', 'chantier', 15, NULL, 'BIF', 0.00, 0.00, 500000.00, 'Caisse associée au chantier KININDO APPARTEMENT', 'active', 22, '2026-07-12 21:11:30', NULL),
(17, 'CAI-2026-017', 'Caisse chantier GIHOSHA NDAYI', 'chantier', 16, NULL, 'BIF', 0.00, 10000000.00, 500000.00, 'Caisse associée au chantier GIHOSHA NDAYI', 'active', 22, '2026-07-12 21:11:30', '2026-07-13 09:22:08'),
(18, 'CAI-2026-018', 'Caisse chantier KINANIRA 3', 'chantier', 17, NULL, 'BIF', 0.00, 20000000.00, 500000.00, 'Caisse associée au chantier KINANIRA 3', 'active', 22, '2026-07-12 21:11:30', '2026-07-13 09:22:47'),
(19, 'CAI-2026-019', 'Caisse chantier Fonctionnemnt', 'chantier', 18, NULL, 'BIF', 0.00, 0.00, 500000.00, 'Caisse associée au chantier Fonctionnemnt', 'active', 22, '2026-07-12 21:11:30', NULL),
(20, 'CAI-2026-020', 'Caisse chantier Chantier Miroir', 'chantier', 19, NULL, 'BIF', 0.00, 0.00, 500000.00, 'Caisse associée au chantier Chantier Miroir', 'active', 22, '2026-07-12 21:11:30', NULL),
(21, 'CAI-2026-021', 'Caisse chantier GASENYI Presidence', 'chantier', 20, NULL, 'BIF', 0.00, 0.00, 500000.00, 'Caisse associée au chantier GASENYI Presidence', 'active', 22, '2026-07-12 21:11:30', NULL),
(22, 'CAI-2026-022', 'Caisse chantier Siège social', 'chantier', 21, NULL, 'BIF', 0.00, 10000000.00, 500000.00, 'Caisse associée au chantier Siège social', 'active', 22, '2026-07-12 21:11:30', '2026-07-15 10:38:36'),
(23, 'CAI-2026-023', 'Caisse chantier Projet Pave', 'chantier', 23, NULL, 'BIF', 0.00, 0.00, 500000.00, 'Caisse associée au chantier Projet Pave', 'active', 22, '2026-07-12 21:11:30', NULL),
(24, 'CAI-2026-024', 'Caisse chantier Maramvya Brique Cute', 'chantier', 24, NULL, 'BIF', 0.00, 35000000.00, 500000.00, 'Caisse associée au chantier Maramvya Brique Cute', 'active', 22, '2026-07-12 21:11:30', '2026-07-13 09:27:49'),
(25, 'CAI-2026-025', 'Caisse chantier Bloque Ciment', 'chantier', 25, NULL, 'BIF', 0.00, 25000000.00, 500000.00, 'Caisse associée au chantier Bloque Ciment', 'active', 22, '2026-07-12 21:11:30', '2026-07-15 10:42:40'),
(26, 'CAI-2026-026', 'Caisse chantier Consultance', 'chantier', 26, NULL, 'BIF', 0.00, 0.00, 500000.00, 'Caisse associée au chantier Consultance', 'active', 22, '2026-07-12 21:11:30', NULL);

-- --------------------------------------------------------

--
-- Structure de la table `tbl_finance_cashbox_operation`
--

CREATE TABLE `tbl_finance_cashbox_operation` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `reference` varchar(40) NOT NULL,
  `operation_type` enum('encaissement','decaissement','approvisionnement') NOT NULL,
  `operation_date` date NOT NULL,
  `source_cashbox_id` bigint(20) UNSIGNED DEFAULT NULL,
  `destination_cashbox_id` bigint(20) UNSIGNED DEFAULT NULL,
...
--
-- Déchargement des données de la table `tbl_finance_cashbox_operation`
--

INSERT INTO `tbl_finance_cashbox_operation` (`id`, `reference`, `operation_type`, `operation_date`, `source_cashbox_id`, `destination_cashbox_id`, `amount`, `currency`, `category`, `third_party`, `payment_method`, `document_number`, `attachment`, `label`, `observation`, `status`, `created_by`, `validated_by`, `created_at`, `updated_at`) VALUES
(1, 'MVT-2026-00001', 'approvisionnement', '2026-07-12', 1, 5, 10000000.00, 'BIF', 'Approvisionnement', 'Caisse General', 'cash', '123456789', '4dba35642413fb7e3d36921c3962e0eb.pdf', 'Approvisionnement de Caisse General vers Caisse chantier KING\'S SCHOOL - Pièce : 123456789', 'Je fais un test', 'validated', 22, 22, '2026-07-12 23:46:30', NULL),
(2, 'MVT-2026-00002', 'encaissement', '2026-07-12', NULL, 6, 10000000.00, 'BIF', 'Autre', 'Baque', 'cash', '33214023', 'cdf27e76f248963d61da9a626aef2c55.pdf', 'Encaissement - Autre - Provenance : Baque - Caisse : Caisse chantier MUHA - Pièce : 33214023', 'Aussi le ts', 'validated', 22, 22, '2026-07-12 23:49:27', NULL),
(3, 'MVT-2026-00003', 'decaissement', '2026-07-12', 6, NULL, 5000000.00, 'BIF', 'Carburant', 'Caisse Muha', 'cash', '6655412', 'dab866d0ed57a07b58fd438c52b0a615.pdf', 'Décaissement - Carburant - Bénéficiaire : Caisse Muha - Caisse : Caisse chantier MUHA - Pièce : 6655412', 'aussi tes', 'validated', 22, 22, '2026-07-12 23:50:43', NULL),
(4, 'MVT-2026-00004', 'approvisionnement', '2026-07-13', 1, 3, 1000000.00, 'BIF', 'Approvisionnement', 'Caisse General', 'cash', '987654', '9769e826d03928fa16665dc5994d980a.pdf', 'Approvisionnement de Caisse General vers Caisse chantier IBB entrepots - Pièce : 987654', 'Encore un test', 'validated', 22, 22, '2026-07-13 09:14:07', NULL),
(5, 'MVT-2026-00005', 'approvisionnement', '2026-07-13', 1, 4, 1000000.00, 'BIF', 'Approvisionnement', 'Caisse General', 'cash', '22313', '05f735f2d8dd728a6c54a7bc96bf5851.pdf', 'Approvisionnement de Caisse General vers Caisse chantier KABEZI - Pièce : 22313', 'Faire un test', 'validated', 22, 22, '2026-07-13 09:15:26', NULL),
(6, 'MVT-2026-00006', 'approvisionnement', '2026-07-13', 1, 5, 1000000.00, 'BIF', 'Approvisionnement', 'Caisse General', 'cash', '324342', 'dab8467536f9501388ccec6fad51170f.pdf', 'Approvisionnement de Caisse General vers Caisse chantier KING\'S SCHOOL - Pièce : 324342', 'faire des test', 'validated', 22, 22, '2026-07-13 09:16:22', NULL),
(7, 'MVT-2026-00007', 'approvisionnement', '2026-07-13', 1, 7, 3000000.00, 'BIF', 'Approvisionnement', 'Caisse General', 'cash', '908089', '23d4be95d17cc36f16e0694a0be674e1.pdf', 'Approvisionnement de Caisse General vers Caisse chantier GIHOSHA APPARTEMENT - Pièce : 908089', NULL, 'validated', 22, 22, '2026-07-13 09:17:40', NULL),
(8, 'MVT-2026-00008', 'encaissement', '2026-07-13', NULL, 8, 6000000.00, 'BIF', 'Autre', 'Gihosha Zone', 'cash', '343242', 'dd6ba3a39de92877884cfc62c9313bf2.pdf', 'Encaissement - Autre - Provenance : Gihosha Zone - Caisse : Caisse chantier GIHOSHA ZONE - Pièce : 343242', 'dgfdgdfgd', 'validated', 22, 22, '2026-07-13 09:19:44', NULL),
(9, 'MVT-2026-00009', 'encaissement', '2026-07-13', NULL, 9, 5000000.00, 'BIF', 'Main-d’œuvre', 'Banque', 'cash', '6575765', 'cab08cbe7a04f2e897eda5988083c69d.pdf', 'Encaissement - Main-d’œuvre - Provenance : Banque - Caisse : Caisse chantier AVENANT 8 - Pièce : 6575765', NULL, 'validated', 22, 22, '2026-07-13 09:20:38', NULL),
(10, 'MVT-2026-00010', 'encaissement', '2026-07-13', NULL, 17, 10000000.00, 'BIF', 'Approvisionnement', 'Banque', 'cash', '987654', '08a3b863616ba82bb9bdb34396768b10.pdf', 'Encaissement - Approvisionnement - Provenance : Banque - Caisse : Caisse chantier GIHOSHA NDAYI - Pièce : 987654', NULL, 'validated', 22, 22, '2026-07-13 09:22:08', NULL),
(11, 'MVT-2026-00011', 'encaissement', '2026-07-13', NULL, 18, 20000000.00, 'BIF', 'Approvisionnement', 'Banque', 'cash', '6655412', 'b24b1025770319756c1de81c126e2830.pdf', 'Encaissement - Approvisionnement - Provenance : Banque - Caisse : Caisse chantier KINANIRA 3 - Pièce : 6655412', NULL, 'validated', 22, 22, '2026-07-13 09:22:47', NULL),
(12, 'MVT-2026-00012', 'decaissement', '2026-07-13', 1, NULL, 15000000.00, 'BIF', 'Fournitures', 'Caisse General', 'cash', '3243242', 'dd16e8c3296b0a6b49924db9ed0fa64e.pdf', 'Décaissement - Fournitures - Bénéficiaire : Caisse General - Caisse : Caisse General - Pièce : 3243242', 'Achat de materiel de bureau', 'validated', 22, 22, '2026-07-13 09:24:15', NULL),
(13, 'MVT-2026-00013', 'decaissement', '2026-07-13', 2, NULL, 8500000.00, 'BIF', 'Carburant', 'Temoin de Jehova', 'cash', '3243432', '6da6cfaeb161a693d207b8c9c4ad92e3.pdf', 'Décaissement - Carburant - Bénéficiaire : Temoin de Jehova - Caisse : TEMOINS DE JEHOVAH - Pièce : 3243432', 'Achats du carburant pour la bétonnière', 'validated', 22, 22, '2026-07-13 09:26:14', NULL),
(14, 'MVT-2026-00014', 'approvisionnement', '2026-07-13', 1, 24, 35000000.00, 'BIF', 'Autre', 'Caisse General', 'cash', '456546456', '4a262bd61e242f1619467e26a8464e7e.pdf', 'Approvisionnement de Caisse General vers Caisse chantier Maramvya Brique Cute - Pièce : 456546456', 'Je fais des tes', 'validated', 22, 22, '2026-07-13 09:27:49', NULL),
(15, 'MVT-2026-00015', 'encaissement', '2026-07-15', NULL, 22, 10000000.00, 'BIF', 'Autre produit', 'Caisse General', 'cash', '234234234', '6ad57422ffe730b499927decc2fec2fe.pdf', 'Encaissement - Autre produit - Provenance : Caisse General - Caisse : Caisse chantier Siège social - Pièce : 234234234', 'fdfsdds', 'validated', 22, 22, '2026-07-15 10:38:36', NULL),
(16, 'MVT-2026-00016', 'encaissement', '2026-07-15', NULL, 25, 25000000.00, 'BIF', 'Paiement client', 'Caisse bloque ciment', 'cash', '987654', 'def0b4a66b741039937d77d0ed16cdf9.pdf', 'Encaissement - Paiement client - Provenance : Caisse bloque ciment - Caisse : Caisse chantier Bloque Ciment - Pièce : 987654', 'dsfsdfsdfs', 'validated', 22, 22, '2026-07-15 10:42:40', NULL),
(17, 'MVT-2026-00017', 'decaissement', '2026-07-15', 1, NULL, 10000000.00, 'BIF', 'Carburant', 'Station Service', 'cash', '234242342', 'd54bc7301178b4c14a86fdef7e565ee3.pdf', 'Décaissement - Carburant - Bénéficiaire : Station Service - Caisse : Caisse General - Pièce : 234242342', 'fgfdgdfgd', 'validated', 22, 22, '2026-07-15 14:20:44', NULL),
(18, 'MVT-2026-00018', 'decaissement', '2026-07-15', 1, NULL, 4000000.00, 'BIF', 'Salaire', 'Ingenieur terrain', 'cash', '34523452342', '5dec25d99ded65ec1714b41c25df928a.pdf', 'Décaissement - Salaire - Bénéficiaire : Ingenieur terrain - Caisse : Caisse General - Pièce : 34523452342', 'dgdfgdfgd', 'validated', 22, 22, '2026-07-15 14:22:41', NULL);
...
--
-- Structure de la table `tbl_finance_expected_receipt`
--

CREATE TABLE `tbl_finance_expected_receipt` (
  `id` int(11) NOT NULL,
  `reference` varchar(30) NOT NULL,
  `client_name` varchar(150) NOT NULL,
  `client_type` varchar(100) DEFAULT NULL,
  `document_type` enum('facture','decompte','avance','credit','autre') NOT NULL DEFAULT 'facture',
  `document_number` varchar(100) DEFAULT NULL,
  `label` varchar(255) NOT NULL,
  `chantier_id` int(11) DEFAULT NULL,
  ...
  `currency` enum('BIF','USD','EUR') NOT NULL DEFAULT 'BIF',
  `status` enum('pending','partial','received','cancelled','overdue') NOT NULL DEFAULT 'pending',
  `observation` text DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
...
--
-- Index pour la table `tbl_engin_maintenance`
--
...
--
-- Index pour la table `tbl_finance_bank_account`
--
ALTER TABLE `tbl_finance_bank_account`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`),
  ADD UNIQUE KEY `account_number` (`account_number`);

--
-- Index pour la table `tbl_finance_bank_operation`
--
ALTER TABLE `tbl_finance_bank_operation`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_bank_operation_reference` (`reference`),
  ADD KEY `idx_bank_operation_type` (`operation_type`),
  ADD KEY `idx_bank_operation_date` (`operation_date`),
  ADD KEY `idx_bank_operation_source` (`source_bank_account_id`),
  ADD KEY `idx_bank_operation_destination` (`destination_bank_account_id`),
  ADD KEY `idx_bank_operation_status` (`status`);
...
ALTER TABLE `tbl_finance_cashbox`
  ...
  ADD UNIQUE KEY `uk_cashbox_chantier` (`chantier_id`),
  ADD KEY `idx_cashbox_type` (`type`),
  ADD KEY `idx_cashbox_chantier` (`chantier_id`),
  ADD KEY `idx_cashbox_status` (`status`);

--
-- Index pour la table `tbl_finance_cashbox_operation`
--
ALTER TABLE `tbl_finance_cashbox_operation`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_cashbox_operation_reference` (`reference`),
  ADD KEY `idx_cashbox_operation_type` (`operation_type`),
  ADD KEY `idx_cashbox_operation_date` (`operation_date`),
  ADD KEY `idx_cashbox_operation_source` (`source_cashbox_id`),
  ADD KEY `idx_cashbox_operation_destination` (`destination_cashbox_id`),
  ADD KEY `idx_cashbox_operation_status` (`status`);
...
--
-- Index pour la table `tbl_finance_expected_receipt`
--
ALTER TABLE `tbl_finance_expected_receipt`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_expected_receipt_reference` (`reference`);
...
--
-- AUTO_INCREMENT pour la table `tbl_finance_bank_account`
--
ALTER TABLE `tbl_finance_bank_account`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT pour la table `tbl_finance_bank_operation`
--
ALTER TABLE `tbl_finance_bank_operation`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT pour la table `tbl_finance_cashbox_operation`
--
ALTER TABLE `tbl_finance_cashbox_operation`
...
--
-- AUTO_INCREMENT pour la table `tbl_finance_expected_receipt`
--
ALTER TABLE `tbl_finance_expected_receipt`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Contraintes pour la table `tbl_finance_bank_operation`
--
ALTER TABLE `tbl_finance_bank_operation`
  ADD CONSTRAINT `fk_bank_operation_destination` FOREIGN KEY (`destination_bank_account_id`) REFERENCES `tbl_finance_bank_account` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_bank_operation_source` FOREIGN KEY (`source_bank_account_id`) REFERENCES `tbl_finance_bank_account` (`id`) ON UPDATE CASCADE;

--
-- Contraintes pour la table `tbl_finance_cashbox_operation`
--
ALTER TABLE `tbl_finance_cashbox_operation`
  ADD CONSTRAINT `fk_cashbox_operation_destination` FOREIGN KEY (`destination_cashbox_id`) REFERENCES `tbl_finance_cashbox` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_cashbox_operation_source` FOREIGN KEY (`source_cashbox_id`) REFERENCES `tbl_finance_cashbox` (`id`) ON UPDATE CASCADE;
